...
import { toSequenceTransaction, toSequenceTransactions, encodeNonce, Transactionish, isTransactionBundle, isSignedTransactionBundle } from '@0xsequence/transactions'
...
describe('Wallet integration', function () {
  ...
  before(async () => {
    ...
    context = {
      ...
      sessionUtils: sequenceUtils.address,
      libs: {
  ...
  describe('with ethers.js', () => {
    ...
    describe('Nested wallets', async () => {
      it('Should use wallet as wallet signer', async () => {
        ...
        // Deploy wallet A
        // otherwise it can't validate signatures
        await walletA.deploy()
  ...
  describe('with web3', () => {
    ...
    describe('signing', async () => {
      it('Should sign transaction', async () => {
        ...
        expect(isSignedTransactionBundle(signed)).to.be.true
